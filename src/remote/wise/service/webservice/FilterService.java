...
public class FilterService 
{
	...
	public List<DealersUnderZoneRespContract> getDealersForZone(@WebParam(name="reqObj") DealersUnderZoneReqContract reqObj)throws CustomFault{
		...
		//WiseLogger infoLogger = WiseLogger.getLogger("FilterService:","info");
		...
		iLogger.info("serviceName:FilterService~executionTime:"+(endTime-startTime)+"~"+UserID+"~");
		return response;
	}
}
