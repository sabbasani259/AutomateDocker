...
public class UserAlertPrefProxy implements Runnable
{
	...
	public void run()
	{
		setUserAlertPref(this.userId, this.prefLevel, this.smsPrefMap, this.emailPrefMap);
	}
	...
	public String setUserAlertPref(String userId, String prefLevel, HashMap<String,String> smsPrefMap, HashMap<String,String> emailPrefMap)
	{
		...
		iLogger.info("MCoreApp:UserAlertPrefProxy:userId: "+userId+" SMS"+" prefLevel: "+prefLevel+" newEmailPrefMap "+ newSmsPrefMap);
		...
		iLogger.info("MCoreApp:UserAlertPrefProxy:userId: "+userId+" Email"+" prefLevel: "+prefLevel+" newEmailPrefMap "+ newEmailPrefMap);
