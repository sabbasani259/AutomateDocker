 ...
 *
 */
public class OrientDbDatasource {
	...
	public static DataSource getOrientDS()
	{
		...
		try 
		{
			...
			iLogger.info("OrientDB Datasource: Get New DS");
			datasource = (DataSource)initialContext.lookup("java:jboss/datasources/OrientdbDS");
	...
	public Connection getConnection() 
	{
		...
		try 
		{
			...
			iLogger.info("OrientDB Datasource: Get New Connection");
