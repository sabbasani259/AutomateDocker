 ...
 *
 */
@WebService(name = "RolledOffMachinesService")
public class RolledOffMachinesService {
		
	@WebMethod(operationName = "getRolledOffMachines", action = "getRolledOffMachines")
	public List<RolledOffMachinesRespContract> getRolledOffMachines(@WebParam(name="reqObj" ) RolledOffMachinesReqContract reqObj) throws CustomFault{
