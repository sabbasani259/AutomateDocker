...
@Path( "AuditLogDetailsServiceRestService")
public class AuditLogDetailsServiceRestService {
	 ...
	 */
	@POST
	@Path( "GetAuditLogDetails")
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces(MediaType.APPLICATION_JSON)
	public List<AuditLogRespContract> getAuditLogDetails( AuditLogReqContract reqObj) {
		...
		List<AuditLogRespContract> respObj=null;
		try {
...
//		}
	 ...
	 respObj = new AuditLogDetailsImpl().getAuditLogDetails(reqObj);
