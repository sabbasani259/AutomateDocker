...
* @author changes by santosh Santosh
*
*/
 
@Path( "FuelUtilizationDetailRestServiceV1")
public class FuelUtilizationDetailRESTServiceV1 {
	 ...
	 */
	@POST
	@Path("getFuelUtilizationDetail")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public List<FuelUtilizationDetailRespContract> getFuelUtilizationDetail(FuelUtilizationDetailReqContract reqObj ) throws CustomFault{
...
//		reqObj.setLoginId(UserID);
		...
		int tenancyId = utilObj.getTenancyIdFromLoginId(reqObj.getLoginId());
...
//			iLogger.info("serialNumber:"+respObj.get(i).getSerialNumber()+","+"period:"+respObj.get(i).getPeriod()+","+"timeDuration:"+respObj.get(i).getTimeDuration()+","+"fuelLevel:"+respObj.get(i).getFuelLevel()+",");
		...
		iLogger.info("serviceName:FuelUtilizationDetailService~executionTime:"+(endTime-startTime)+"~"+reqObj.getLoginId()+"~");
		return respObj;
	}
