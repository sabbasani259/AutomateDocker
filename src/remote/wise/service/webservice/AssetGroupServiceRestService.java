 ...
 */
@Path("AssetGroupServiceRestService")
public class AssetGroupServiceRestService
{
	 ...
	 * @throws CustomFault
	 */
	@Path( "SetCustomAssetGroup")
	@POST
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public AssetGroupReqContract setCustomAssetGroup(AssetGroupRespContract reqObj) throws CustomFault
	{
	 ...
	 * @throws CustomFault
	 */
	@Path("GetCustomAssetGroup")
	@POST
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public List<AssetGroupRespContract> getCustomAssetGroup(AssetGroupReqContract reqObj) 
	{
		//DefectId:1337 - Rajani Nagaraju - 20130923 - Log4j Changes - Using static logger object all throught the application
		//WiseLogger infoLogger = WiseLogger.getLogger("AssetGroupService:","info");
		Logger iLogger = InfoLoggerClass.logger;
		...
		List<AssetGroupRespContract> response =null;
		try {
...
//		}
		...
		iLogger.info("Decoded userId::"+reqObj.getLoginId());
		 ...
		 response = new AssetGroupImpl().getAssetGroup(reqObj);
