 ...
 *
 */
@WebService(name = "GetDealersForZoneService")
public class GetDealersForZoneService {
	...
	public List<DealersUnderZoneRespContract> getDealersForZone(@WebParam(name="reqObj") DealersUnderZoneReqContract reqObj)throws CustomFault{
		...
		//WiseLogger infoLogger = WiseLogger.getLogger("GetDealersForZoneService:","info");
		...
		iLogger.info("serviceName:GetDealersForZoneService~executionTime:"+(endTime-startTime)+"~"+response+"~");
		return response;
	}
}