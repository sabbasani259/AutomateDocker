 ...
 *
 */
@Path( "MachineProfileServiceRestService")
public class MachineProfileServiceRestService {
	 ...
	 * @throws CustomFault
	 */
	@Path( "GetMachineProfileService")
	@POST
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public List<MachineProfileRespContract> getMachineProfileService( MachineProfileReqContract reqObj)throws CustomFault {
