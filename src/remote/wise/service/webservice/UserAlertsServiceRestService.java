 ...
 *
 */
@Path( "UserAlertsServiceRestService")
public class UserAlertsServiceRestService 
{	
	...
	public List<UserAlertsRespContract> getUserAlerts(UserAlertsReqContract reqObj) 
	{
	...
	public String setUserAlertsCloser( UserAlertsCloserRespContract respObj) 
	{
		...
		iLogger.info("Decoded userId::"+respObj.getLoginID());
		 ...
		 response_msg= new UserAlertsImpl().setUserAlertsCloserDetails(respObj.getSerialNumber(), respObj.getLoginID(), respObj.getJobCardNumber(), respObj.getServicedDate(), respObj.getMessageId(),respObj.getEventGeneratedTime());
		iLogger.info("----- Webservice Output-----");
