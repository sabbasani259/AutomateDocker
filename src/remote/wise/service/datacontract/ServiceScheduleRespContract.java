...
public class ServiceScheduleRespContract {
	...
	private int assetGpId;
	private String assetGpName;
	...
	public void setAssetGpId(int assetGpId) {
		this.assetGpId = assetGpId;
	}
	...
	public void setAssetGpName(String assetGpName) {
		this.assetGpName = assetGpName;
	}
