...
public class MoolErrorMsgHandler 
{
	public String handleErrorMessages(String messageId, String fileName, String process, String messageString, String failureCause)
	{
		...
		try
		{
			...
			catch(Exception e)
			{
				...
				fLogger.fatal("MoolErrorMsgHandler: process:"+process+":messageString:"+messageString+": Exception in Storing details into mool_fault_details:"+e.getMessage());
			}
			...
			finally
			{
				...
				{
					errorMsgInsStatus="FAILURE";
					fLogger.fatal("MoolErrorMsgHandler: process:"+process+": messageString:"+messageString+": Exception in commiting details into mool_fault_details:"+e.getMessage());
		...
		{
			errorMsgInsStatus="FAILURE";
			fLogger.fatal("MoolErrorMsgHandler: process:"+process+": messageString:"+messageString+": Exception in getting Hibernate Session:"+e.getMessage());
		}
	...
	public void fileHandler(String messageId, String fileRef, String process, String messageString, String failureCause)
	{
		...
		{
			fLogger.fatal("RED ALERT:MoolErrorMsgHandler: FileHandler: process:"+process+": messageString:"+messageString+":Error in storing the details");
		}
		...
		finally
		{
			...
			{
				fLogger.fatal("MoolErrorMsgHandler: FileHandler: process:"+process+": messageString:"+messageString+":Error in closing FileWriter");
			}
		}
	}
	...
	public void fileToDBHandler(String fileName)
	{
    	...
    	{
    		fLogger.fatal("MoolErrorMsgHandler: fileToDBHandler:"+"Error in reading data from File:"+e.getMessage());
    	...
    	finally
    	{
    		if(br!=null)
    			...
    			{
					fLogger.fatal("MoolErrorMsgHandler: fileToDBHandler:"+"Error in closing Buffered reader:"+e.getMessage());
				}	 
    	}
	...
	public void deleteErrorMessage(String messageId)
	{
      ...
      //DF20150603 - Rajani Nagaraju - WISE going down issue - Open a new session when the getCurrentSession returns a dirty session(txns which is not yet committed exists)
		...
		{
        	fLogger.fatal("MoolErrorMsgHandler: deleteErrorMessage: Exception :"+e.getMessage());
		}
        ...
        finally
        {
			...
			{
				fLogger.fatal("MoolErrorMsgHandler: deleteErrorMessage: Exception in comitting the record:"+e2.getMessage());
			}
