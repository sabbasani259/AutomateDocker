...
@WebService(name = "SMSAlertsService")
public class SMSAlertsService 
{
	@WebMethod(operationName = "getSMSAlerts", action = "getSMSAlerts")
	public List<SMSAlertsRespContract> getSMSAlerts(@WebParam(name="reqObj" ) SMSAlertsReqContract reqObj)
	{
		//WiseLogger infoLogger = WiseLogger.getLogger("SMSAlertsService:","info");
		...
		List<SMSAlertsRespContract> response = new SMSAlertsImpl().getSMSAlerts(reqObj);
		...
		iLogger.info("serviceName:SMSAlertsService~executionTime:"+(endTime-startTime)+"~"+""+"~");
