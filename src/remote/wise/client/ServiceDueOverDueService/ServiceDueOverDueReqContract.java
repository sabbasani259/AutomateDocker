...
/**
 * <p>Java class for serviceDueOverDueReqContract complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="serviceDueOverDueReqContract">
 *   &lt;complexContent>
 ...
 *         &lt;element name="landmarkCategoryList" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "serviceDueOverDueReqContract", propOrder = {
    "activeAlerts",
    "assetGroupIdList",
    "assetTypeIdList",
...
public class ServiceDueOverDueReqContract {
    ...
    @XmlElement(nillable = true)
    protected List<Integer> landmarkCategoryList;
    @XmlElement(nillable = true)
    ...
    public List<Integer> getLandmarkCategoryList() {
        if (landmarkCategoryList == null) {
            landmarkCategoryList = new ArrayList<Integer>();
        }
