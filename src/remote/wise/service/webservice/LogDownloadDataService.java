...
import remote.wise.service.implementation.LogDownloadDataServiceImpl;
import remote.wise.util.CommonUtil;
import remote.wise.util.ListToStringConversion;

@Path("/LogDownloadService")
public class LogDownloadDataService {
	
	@POST
	@Path("/getLogDownloadDataReport")
	@Produces(MediaType.APPLICATION_JSON) 
	@Consumes(MediaType.APPLICATION_JSON)
	public List<HashMap<String, String>> getLogMonitorReport(HashMap<String, Object> requestObj) throws Exception {
		...
		infoLogger.info("getLogDownloadDataReport::Webservice Start::vinList:" + vinList +" startdate: "+startdate+"  enddate :"+enddate);
		...
		if(!isValidinput3.equals("SUCCESS")){
		 ...
		 response = new LogDownloadDataServiceImpl().getLogDownloadDataReport(vinList,startdate,enddate);
		 infoLogger.info("getLogDownloadDataReport::Webservice End :: "+response);
		return response;
