 ...
 *
 */
@WebService(name = "AssetDashboardService")
public class AssetDashboardService 
{
	...
	public List<AssetDashboardRespContract> getAssetDashboardDetails(@WebParam(name="reqObj" ) AssetDashboardReqContract reqObj) throws CustomFault
	{
		...
		List<AssetDashboardRespContract> response = new AssetDashboardImpl().getAssetDashboardDetails(reqObj,nickName);
