...
public class InsertComRepoEnchIntoCVSFileDAO {
	...
	public String insertIntoCSVGile() {
		...
		try {
			...
			if (connection == null) {
				...
				String countQuery = "select count(*) from com_rep_oem_enhanced";
				...
				File file = new File("/user/JCBLiveLink/COMMReport/CommReport.csv");
