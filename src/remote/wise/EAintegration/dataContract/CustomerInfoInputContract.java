...
public class CustomerInfoInputContract implements Serializable
{
	...
	/**
	 * @return the primaryDealerCode
	 */
	public String getPrimaryDealerCode() {
		return primaryDealerCode;
	}
	/**
	 * @param primaryDealerCode the primaryDealerCode to set
	 */
	public void setPrimaryDealerCode(String primaryDealerCode) {
		this.primaryDealerCode = primaryDealerCode;
	}
	/**
