...
//	}
	...
	//JCB6634 : Sai Divya : 20241126 : LLPremiumTabChanges.n
			...
			@Path("/getMachineList")
			@Produces(MediaType.APPLICATION_JSON)
			public String getPremiumMachines(
					@QueryParam("tenancyId") String tenancyId,
					@QueryParam("vin") String vin,
					@QueryParam("platform") String platform,
					@QueryParam("model") String model,
					...
					@QueryParam("endLimit") int endLimit,
					@QueryParam("limitFlag") String limitFlag,
					@DefaultValue("false")@QueryParam("flag") boolean downflag
					) throws Exception {
				...
				if( premiumFlag.equalsIgnoreCase("0") && !installationStartDate.equalsIgnoreCase("null") && installationStartDate != null && installationStartDate != "NA"
				 ...
				 response = new LLPremiumServiceImpl()
						.getMachineListUnderTenancyId(tenancyId, vin, platform, model,
								dealerName, customerName, premiumFlag ,premiumStartDate,premiumEndDate, installationStartDate , installationEndDate , startLimit , endLimit , 
								limitFlag,downflag);
